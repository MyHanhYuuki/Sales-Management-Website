...
namespace Business.Implements
{
    ...
    {
        private QLWebDBEntities dbContext;
        ...
        public async Task Create(PhieuDatHangViewModel obj)
        {
            ...
            order.ChiTietPhieuDatHangs = new List<ChiTietPhieuDatHang>();

            foreach (var i in obj.chiTietPhieuDatHang)
            {
                order.ChiTietPhieuDatHangs.Add(i);
            }
        ...
        {
            var phieuBanHang = (new PhieuBanHangReponsitory(dbContext)).GetAll();
